 ...
 * up to version 1588574301.
 * Generated on 2020-05-04 06:38:21 by root
 */
class PropelMigration_1588574301
{
    public $comment = '';
...
CREATE SEQUENCE "spy_product_abstract_merchant_pk_seq";

CREATE TABLE "spy_product_abstract_merchant"
(
    "id_product_abstract_merchant" INTEGER NOT NULL,
    "fk_merchant" INTEGER NOT NULL,
    "fk_product_abstract" INTEGER NOT NULL,
    "created_at" TIMESTAMP,
    "updated_at" TIMESTAMP,
    PRIMARY KEY ("id_product_abstract_merchant"),
    CONSTRAINT "spy_product_abstract_merchant-unique-fk_product_abstract" UNIQUE ("fk_product_abstract")
);

CREATE INDEX "spy_product_abstract_merchant-index-fk_merchant" ON "spy_product_abstract_merchant" ("fk_merchant");

CREATE INDEX "spy_product_abstract_merchant-index-fk_product_abstract" ON "spy_product_abstract_merchant" ("fk_product_abstract");
...
ALTER TABLE "spy_product_abstract_merchant" ADD CONSTRAINT "spy_product_abstract_merchant-fk_merchant"
    FOREIGN KEY ("fk_merchant")
    REFERENCES "spy_merchant" ("id_merchant");

ALTER TABLE "spy_product_abstract_merchant" ADD CONSTRAINT "spy_product_abstract_merchant-fk_product_abstract"
    FOREIGN KEY ("fk_product_abstract")
    REFERENCES "spy_product_abstract" ("id_product_abstract");
...
DROP TABLE IF EXISTS "spy_product_abstract_merchant" CASCADE;

DROP SEQUENCE "spy_product_abstract_merchant_pk_seq";
